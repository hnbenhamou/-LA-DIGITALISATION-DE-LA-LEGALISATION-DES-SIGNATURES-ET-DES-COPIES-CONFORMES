                      ...
                      <div className="boxes">
                        <div className="boxeswrap">
                          ...
                          <div className="icontext">
                            <h5>suivre le status de votre demande</h5>
                            <p>Vous pouvez télécharger vos fichier facilement et rapidement.</p>
                            <Link to="/statut"> Un petit clic ici </Link>
                          </div>
                        </div>
                    ...
                    <div className="col-md-6">
                      <div className="boxes">
                        <div className="boxeswrap">
                          ...
                          <div className="icontext">
                            <h5>Effectuer une  demande d'égalisation</h5>
                            <p>Vous pouvez également harmoniser vos fichiers sans difficulté</p>
                          </div>
                        </div>
                        <Link to="/demandeEgal"> Un petit clic ici </Link>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                      ...
                      <div className="boxes">
                        <div className="boxeswrap">
                          ...
                          <div className="icontext">
                            ...
                            <Link to="/dashbord"> Un petit clic ici </Link>
                          </div>
                        </div>
